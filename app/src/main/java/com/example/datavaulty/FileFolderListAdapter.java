...
public class FileFolderListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    Context mContext;
    ...
    public FileFolderListAdapter(Context context, List<Model_Files_1> moviesList, ArrayList<String> TotalFolder) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == RECIPE) {
            View contactView = inflater.inflate(R.layout.file_folder_list_item, parent, false);
